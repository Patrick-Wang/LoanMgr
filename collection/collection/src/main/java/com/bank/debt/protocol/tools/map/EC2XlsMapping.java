...
public class EC2XlsMapping implements Mapping<List<EC>, OutputStream> {
	...
	public static String[] creditLoanTitle = new String[] {"委案编号", "批次号", "委外日期", "委外状态", "委外机构", "委外金额", "已还金额","剩余金额",
	...
	public static String[] creditCardTitle = new String[] {"委案编号", "批次号", "委外日期", "委外状态", "委外机构", "委外金额", "已还金额","剩余金额",
