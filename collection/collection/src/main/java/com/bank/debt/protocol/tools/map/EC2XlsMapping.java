...
public class EC2XlsMapping implements Mapping<List<EC>, OutputStream> {
	...
	public static String[] carLoanTitle = new String[] { "序号", "委案编号", "批次号", "委外日期", "委外状态", "委外机构", "委外金额", "已还金额",
	...
	public static String[] creditLoanTitle = new String[] { "序号", "委案编号", "批次号", "委外日期", "委外状态", "委外机构", "委外金额", "已还金额",
