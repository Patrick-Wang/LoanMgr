...
public class EC2XlsMapping implements Mapping<List<EC>, OutputStream> {
	...
	public static String[] carLoanTitle = new String[] { "序号", "委案编号", "批次号", "委外日期", "委外状态", "委外机构", "委外金额", "已还金额","剩余金额",
			"备注", "委外到期日", "结案日期", "客户姓名", "合同编号", "外包商编号", "委外类型", "客户性别", "客户出生日期", "客户身份证号", "外访期数", "外访金额", "逾期天数",
			"逾期金额", "月供车款金额", "贷款期限", "逾期期数", "曾经逾期次数", "还款期数", "城市", "经销商", "客户手机", "客户宅电", "客户公司", "客户公司电话", "分区",
			"区号", "邮编", "配偶姓名", "配偶手机", "其他联系方式", "配偶公司", "配偶公司电话", "客户类型", "申请日期", "放款日期", "还款日", "保单到期日", "贷款金额",
			"贷款种类", "客户利率", "车价", "车型", "职位", "收入", "担保人姓名", "与申请人关系", "担保人出生日期", "担保人身份证号", "担保人手机", "担保人公司名称",
			"担保人公司电话", "担保人公司地址", "银行", "帐号", "网银导出原因", "逾期原因", "电话情况", "电话联系人", "还款情况", "还款人", "信息修改类别", "车辆情况",
			"客户合作态度", "处理状态", "反馈日期", "委外结果", "PCODE", "CCODE" };

	public static String[] creditLoanTitle = new String[] { "序号", "委案编号", "批次号", "委外日期", "委外状态", "委外机构", "委外金额", "已还金额","剩余金额",
			"备注", "客户号", "客户姓名", "账户号", "性别", "身份证号", "放款机构", "签约金额", "放款金额", "产品类型", "放款时间", "提前结清金额", "总期数", "当前期数",
			"已还期数", "剩余本金", "逾期利息", "逾期罚息", "逾期管理费", "逾期违约金", "逾期本金", "未还本金", "月还款额", "账户名", "银行名", "银行帐号", "归集公司",
			"逾期天数", "账龄", "城市", "电子邮箱", "户籍电话", "户籍地址", "手机号码", "住宅电话", "住宅地址", "公司名称", "公司地址", "公司电话", "联络人1姓名",
			"联络人1关系", "联络人1电话", "联络人2姓名", "联络人2关系", "联络人2电话", "联络人3姓名", "联络人3关系", "联络人3电话", "联络人4姓名", "联络人4关系",
			"联络人4电话", "联络人5姓名", "联络人5关系", "联络人5电话", "联络人6姓名", "联络人6关系", "联络人6电话", "联络人7姓名", "联络人7关系", "联络人7电话",
			"联络人8姓名", "联络人8关系", "联络人8电话", "联络人9姓名", "联络人9关系", "联络人9电话", "联络人10姓名", "联络人10关系", "联络人10电话" };

	public static String[] creditCardTitle = new String[] { "ID", "委案编号", "批次号", "委外日期", "委外状态", "委外机构", "委外金额", "已还金额","剩余金额",
...
//		List<Field> fds = null;
//		if (!ecqi.isEmpty()) {
//			fds = BeanUtil.getDirectFields(ecqi.get(0).getClass());
//		}
...
//			}
		...
		for (int j = 0; j < ecqi.size(); ++j) {
			...
			for (int i = 0; i < titles.length; ++i) {
				...
				cell.setCellValue(null != ecqi.get(j).getLoan().get(i) ? ecqi.get(j).getLoan().get(i) + "" : "");
			}
