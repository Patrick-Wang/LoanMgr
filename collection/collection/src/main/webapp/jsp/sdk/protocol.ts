...
module collection.protocol {
    ...
    export let carLoanTitle:string[] = [
        "委案编号", "批次号", "委外日期", "委外状态", "委外机构", "委外金额", "已还金额", "剩余金额",
        "委外到期日", "结案日期", "客户姓名",
        "合同编号", "外包商编号", "委外类型", "客户性别", "客户出生日期", "客户身份证号",  "身份证归属地", "外访期数", "外访金额", "逾期天数", "逾期金额", "月供车款金额", "贷款期限",
    ...
    export let creditLoanTitle:string[] = [
        "委案编号", "批次号", "委外日期", "委外状态", "委外机构", "委外金额", "已还金额", "剩余金额",
        "客户号", "客户姓名", "账户号", "性别", "身份证号",  "身份证归属地", "放款机构", "签约金额", "放款金额", "产品类型", "放款时间", "提前结清金额", "总期数", "当前期数", "已还期数",
