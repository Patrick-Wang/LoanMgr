    ...
    return {
        ...
        init: function () {
            ...
            var treeDataSource2 = new DataSourceTree({
                data: [
                    { name: '内勤部 <div class="tree-actions"></div>', type: 'folder', additionalParameters: { id: 'F11' } },
                    { name: '业务部 <div class="tree-actions"></div>', type: 'folder', additionalParameters: { id: 'F12' } },
                    { name: '<i class="fa fa-user gold"></i> 石总', type: 'item', additionalParameters: { id: 'I11' } },
                ],
                delay: 400
            });
