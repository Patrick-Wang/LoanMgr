					...
					<div class="buttons-preview pull-right">
						<div class="btn-group">
							<button type="button" class="btn btn-default"
								id="bootbox-clieck-to-working">设为工作中</button>
							<button type="button" class="btn btn-default"
								id="bootbox-clieck-to-done">设为已退案</button>
						</div>
						<div class="btn-group">
							<button type="button" class="btn btn-default" id="bootbox-modify">修改回款额</button>
						</div>
						<div class="btn-group">
							<button type="button" class="btn btn-default"
								id="bootbox-record-work">工作记录</button>
							<button type="button" class="btn btn-default"
								id="bootbox-record-by-phone">电话访谈</button>
						</div>
						<div class="btn-group">
							<button type="button" class="btn btn-default"
								id="bootbox-options">委案咨询</button>
						</div>
						<div class="btn-group">
							<button type="button" class="btn btn-default"
								id="bootbox-modify-attach">修改附件属性</button>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-sm-12">
				<ul class="timeline">
					...
					<li class="timeline-node"><a class="btn btn-lg btn-darkorange"
						id="bootbox-record-ask-timeline">咨询记录 +</a></li>
					<li class="timeline-inverted">
						<div class="timeline-datetime">
							<span class="timeline-time"> 8:19 </span><span
								class="timeline-date">2017年5月12日</span>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="form-group">
					<input type="text" class="form-control" placeholder="标题：注明委案编号"
						required="">
				</div>
				<div class="form-group">
					<textarea class="form-control" placeholder="内容" rows="5"
						required=""></textarea>
				</div>
			</div>
		</div>
