                ...
                <div class="buttons-preview pull-left">
                    <div class="btn-group">
                        <button type="button" class="btn btn-default" style="display:none"
                                id="bootbox-click-to-working">设为工作中
                        </button>
                        <button type="button" class="btn btn-default" style="display:none"
                                id="bootbox-click-to-done">设为已退案
                        </button>
                    </div>
                    <div class="btn-group">
                        <button type="button" class="btn btn-default" style="display:none"
                                id="bootbox-modify-repayment">修改回款额
                        </button>
                    </div>
                    <div class="btn-group">
                        <button type="button" class="btn btn-default" style="display:none"
                                id="bootbox-record-work">工作记录
                        </button>
                        <button type="button" class="btn btn-default" style="display:none"
                                id="bootbox-record-work-by-phone">电话访谈
                        </button>
                    </div>
                    <div class="btn-group">
                        <button type="button" class="btn btn-default" style="display:none"
                                id="bootbox-loans-consulting">委案咨询
                        </button>
                    </div>
                    <div class="btn-group">
                        <button type="button" class="btn btn-default" style="display:none"
                                id="bootbox-modify-attachment-property">修改附件属性
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="buttons-preview pull-right">
                    <div class="btn-group">
                        <button type="button" class="btn btn-default"
                                id="bootbox-click-to-ppg">&lt;&lt;上一条
                        </button>
                        <div type="button" class="btn btn-default"
                             id="bootbox-click-to-pgnum"></div>
                        <button type="button" class="btn btn-default"
                                id="bootbox-click-to-npg">下一条&gt;&gt;
                        </button>
                    </div>
                </div>
            </div>
...
<div id="template_report_work_by_phone" style="display: none;">
    <div>
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <textarea class="form-control" placeholder="内容" rows="4" required=""></textarea>
                </div>
            </div>
            <div class="col-md-2">
                <a href="javascript:void(0);"
                        class="btn btn-darkorange btn-circle btn-sm" style="display:none"><i
