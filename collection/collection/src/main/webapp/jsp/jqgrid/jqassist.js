...
(function (JQTable) {
    ...
    var JQGridAssistant = (function () {
        ...
        //				};
        //			},
        JQGridAssistant.prototype.isMSIE = function () {
        ...
        JQGridAssistant.prototype.indexOf = function (arr, val) {
        ...
        JQGridAssistant.prototype.enablePageEdit = function (rowNum, pagername) {
            ...
            var opt = {
                ...
                afterSaveCell: function () {
                    ...
                    var ids = grid.jqGrid('getDataIDs');
                    if (_this.indexOf(_this.mEditedRows, ids[lastsel - 1]) < 0) {
                ...
                setTimeout(function () {
                    ...
                    grid.jqGrid('navGrid', pagername, {
                        ...
                        delfunc: function (rowid) {
                            ...
                            var ind = _this.indexOf(_this.mEditedRows, rowid);
                            if (ind >= 0) {
        ...
        JQGridAssistant.prototype.decorate = function (option) {
            ...
            if (typeof option.datatype == 'function') {
                var stub_1 = option.datatype;
                var init_1 = true;
                option.datatype = function (postdata) {
                    try {
                        if (!init_1) {
                            _this.cleanSelRow();
                            return stub_1(postdata);
                        }
                        else {
                            init_1 = false;
                        }
