...
<head>
    ...
    <link href="${pageContext.request.contextPath}/jsp/assets/css/weather-icons.min.css" rel="stylesheet" />
...
<!--     <link href="../fonts.googleapis.com/css@family=open+sans_3a300italic,400italic,600italic,700italic,400,600,700,300.css"
    ...
    <!--Beyond styles-->
    <link href="${pageContext.request.contextPath}/jsp/assets/css/beyond.min.css" rel="stylesheet" />
    <link href="${pageContext.request.contextPath}/jsp/assets/css/demo.min.css" rel="stylesheet" />
    <link href="${pageContext.request.contextPath}/jsp/assets/css/typicons.min.css" rel="stylesheet" />
...
<body>
                        ...
                        <ul class="account-area">
                            ...
                            <li>
                                ...
                                <ul class="pull-right dropdown-menu dropdown-arrow dropdown-messages">
                                    <li>
                                        <a href="#">
                                            <img src="${pageContext.request.contextPath}/jsp/assets/img/avatars/divyia.jpg" class="message-avatar" alt="Divyia Austin">
                                            <div class="message">
                                    ...
                                    <li>
                                        <a href="#">
                                            <img src="${pageContext.request.contextPath}/jsp/assets/img/avatars/bing.png" class="message-avatar" alt="Microsoft Bing">
                                            <div class="message">
                                                <span class="message-sender">
                                                    Bing.com
                                                </span>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img src="${pageContext.request.contextPath}/jsp/assets/img/avatars/adam-jansen.jpg" class="message-avatar" alt="Divyia Austin">
                                            <div class="message">
                                                <span class="message-sender">
                                                    Nicolas
                                                </span>
                                ...
                                <ul class="pull-right dropdown-menu dropdown-arrow dropdown-login-area">
                                    ...
                                    <li>
                                        <div class="avatar-area">
                                            <img src="${pageContext.request.contextPath}/jsp/assets/img/avatars/adam-jansen.jpg" class="avatar">
                    ...
                    <ul class="contacts-list">
                        <li class="contact">
                            <div class="contact-avatar">
                                <img src="${pageContext.request.contextPath}/jsp/assets/img/avatars/divyia.jpg" />
                            </div>
                        ...
                        <li class="contact">
                            <div class="contact-avatar">
                                <img src="${pageContext.request.contextPath}/jsp/assets/img/avatars/nicolai-larson.jpg" />
                            </div>
                            <div class="contact-info">
                        ...
                        <li class="contact">
                            <div class="contact-avatar">
                                <img src="${pageContext.request.contextPath}/jsp/assets/img/avatars/john-smith.jpg" />
                            </div>
                            <div class="contact-info">
                        ...
                        <li class="contact">
                            <div class="contact-avatar">
                                <img src="${pageContext.request.contextPath}/jsp/assets/img/avatars/osvaldus-valutis.jpg" />
                            </div>
                            <div class="contact-info">
                        ...
                        <li class="contact">
                            <div class="contact-avatar">
                                <img src="${pageContext.request.contextPath}/jsp/assets/img/avatars/javi-jimenez.jpg" />
                            </div>
                            <div class="contact-info">
                        ...
                        <li class="contact">
                            <div class="contact-avatar">
                                <img src="${pageContext.request.contextPath}/jsp/assets/img/avatars/stephanie-walter.jpg" />
                            </div>
                            <div class="contact-info">
                        ...
                        <li class="contact">
                            <div class="contact-avatar">
                                <img src="${pageContext.request.contextPath}/jsp/assets/img/avatars/sergey-azovskiy.jpg" />
                            </div>
                            <div class="contact-info">
                        ...
                        <li class="contact">
                            <div class="contact-avatar">
                                <img src="${pageContext.request.contextPath}/jsp/assets/img/avatars/lee-munroe.jpg" />
                            </div>
                            <div class="contact-info">
    ...
    <!--Beyond Scripts-->
    <script src="${pageContext.request.contextPath}/jsp/assets/js/beyond.min.js"></script>
