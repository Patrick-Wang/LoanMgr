    ...
    (function (ec) {
        ...
        (function (exporter_1) {
            ...
            authority.register(ADDR, function () {
                ...
                pages.PageUtil.jqPage(pages.PageType.loansMgr).find("#lm-export").append(ReactDOMServer.renderToStaticMarkup(React.createElement("a", {"id": "lm-export-Btn", "className": "btn btn-default", "style": { float: "right" }}, "导出")));
