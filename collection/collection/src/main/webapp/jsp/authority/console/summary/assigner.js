            ...
            route.router.register(new Receiver("/console/summary/assigner", function (e) {
                switch (e.id) {
                    case route.MSG.PAGE_REFRESH:
                        ...
                        break;
                    case MSG_REFRESH:
                        var html = ReactDOMServer.renderToStaticMarkup(React.createElement("li", {"class": "tab-palegreen"}, React.createElement("a", {"data-toggle": "tab", "id": "contacttab2", "href": "#waitRepliedMsg"}, " 待回复咨询 ")));
