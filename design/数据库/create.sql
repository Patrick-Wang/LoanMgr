...
create table `entrusted_case_car_loan`(				
	...
	`lxr1xm`	varchar(100)	,--	联系人1姓名
	`lxr1zjh`	varchar(100)	,--	联系人1证件号
	`lxr1gx`	varchar(100)	,--	联系人1关系
	`lxr1dw`	varchar(100)	,--	联系人1单位
	`lxr1jtdh`	varchar(100)	,--	联系人1家庭电话
	...
	`lxr2dw`	varchar(100)	,--	联系人2单位
	`lxr2jtdh`	varchar(100)	,--	联系人2家庭电话
	`lxr2dwdh`	varchar(100)	,--	联系人2单位电话
	`lxr2sj`	varchar(100)	,--	联系人2手机
	`lxr2dz`	varchar(100)	,--	联系人2地址
	`bz2`	varchar(100)	,--	备注2
	`lxr3xm`	varchar(100)	,--	联系人3姓名
	`lxr3zjh`	varchar(100)	,--	联系人3证件号
	`lxr3gx`	varchar(100)	,--	联系人3关系
	`lxr3dw`	varchar(100)	,--	联系人3单位
	`lxr3jtdh`	varchar(100)	,--	联系人3家庭电话
	`lxr3dwdh`	varchar(100)	,--	联系人3单位电话
	`lxr3sj`	varchar(100)	,--	联系人3手机
	`lxr3dz`	varchar(100)	,--	联系人3地址
	`bz3`	varchar(100)	,--	备注3
	`lxr4xm`	varchar(100)	,--	联系人4姓名
	`lxr4zjh`	varchar(100)	,--	联系人4证件号
	`lxr4gx`	varchar(100)	,--	联系人4关系
	`lxr4dw`	varchar(100)	,--	联系人4单位
	`lxr4jtdh`	varchar(100)	,--	联系人4家庭电话
	`lxr4dwdh`	varchar(100)	,--	联系人4单位电话
	`lxr4sj`	varchar(100)	,--	联系人4手机
	`lxr4dz`	varchar(100)	,--	联系人4地址
	`bz4`	varchar(100)	,--	备注4
	`lxr5xm`	varchar(100)	,--	联系人5姓名
	`lxr5zjh`	varchar(100)	,--	联系人5证件号
	`lxr5gx`	varchar(100)	,--	联系人5关系
	`lxr5dw`	varchar(100)	,--	联系人5单位
	`lxr5jtdh`	varchar(100)	,--	联系人5家庭电话
	`lxr5dwdh`	varchar(100)	,--	联系人5单位电话
	`lxr5sj`	varchar(100)	,--	联系人5手机
	`lxr5dz`	varchar(100)	,--	联系人5地址
	`bz5`	varchar(100)	,--	备注5
	`lxr6xm`	varchar(100)	,--	联系人6姓名
	`lxr6zjh`	varchar(100)	,--	联系人6证件号
	`lxr6gx`	varchar(100)	,--	联系人6关系
	`lxr6dw`	varchar(100)	,--	联系人6单位
	`lxr6jtdh`	varchar(100)	,--	联系人6家庭电话
	`lxr6dwdh`	varchar(100)	,--	联系人6单位电话
	`lxr6sj`	varchar(100)	,--	联系人6手机
	`lxr6dz`	varchar(100)	,--	联系人6地址
	`bz6`	varchar(100)	,--	备注6
	`lxr7xm`	varchar(100)	,--	联系人7姓名
	`lxr7zjh`	varchar(100)	,--	联系人7证件号
	`lxr7gx`	varchar(100)	,--	联系人7关系
	`lxr7dw`	varchar(100)	,--	联系人7单位
	`lxr7jtdh`	varchar(100)	,--	联系人7家庭电话
	`lxr7dwdh`	varchar(100)	,--	联系人7单位电话
	`lxr7sj`	varchar(100)	,--	联系人7手机
	`lxr7dz`	varchar(100)	,--	联系人7地址
	`bz7`	varchar(100)	,--	备注7
	`lxr8xm`	varchar(100)	,--	联系人8姓名
	`lxr8zjh`	varchar(100)	,--	联系人8证件号
	`lxr8gx`	varchar(100)	,--	联系人8关系
	`lxr8dw`	varchar(100)	,--	联系人8单位
	`lxr8jtdh`	varchar(100)	,--	联系人8家庭电话
	`lxr8dwdh`	varchar(100)	,--	联系人8单位电话
	`lxr8sj`	varchar(100)	,--	联系人8手机
	`lxr8dz`	varchar(100)	,--	联系人8地址
	`bz8`	varchar(100)	,--	备注8
	`lxr9xm`	varchar(100)	,--	联系人9姓名
	`lxr9zjh`	varchar(100)	,--	联系人9证件号
	`lxr9gx`	varchar(100)	,--	联系人9关系
	`lxr9dw`	varchar(100)	,--	联系人9单位
	`lxr9jtdh`	varchar(100)	,--	联系人9家庭电话
	`lxr9dwdh`	varchar(100)	,--	联系人9单位电话
	`lxr9sj`	varchar(100)	,--	联系人9手机
	`lxr9dz`	varchar(100)	,--	联系人9地址
	`bz9`	varchar(100)	,--	备注9
	`lxr10xm`	varchar(100)	,--	联系人10姓名
	`lxr10zjh`	varchar(100)	,--	联系人10证件号
	`lxr10gx`	varchar(100)	,--	联系人10关系
	`lxr10dw`	varchar(100)	,--	联系人10单位
	`lxr10jtdh`	varchar(100)	,--	联系人10家庭电话
	`lxr10dwdh`	varchar(100)	,--	联系人10单位电话
	`lxr10sj`	varchar(100)	,--	联系人10手机
	`lxr10dz`	varchar(100)	,--	联系人10地址
	`bz10`	varchar(100)	,--	备注10
	PRIMARY KEY (`id`)
)ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8;	
...
insert into areas (PID, area) values 
('110000', '北京市'),
('110100', '北京市市辖区'),
('110101', '北京市东城区'),
('110102', '北京市西城区'),
...
('659002', '新疆维吾尔族自治区阿拉尔市'),
('659003', '新疆维吾尔族自治区图木舒克市'),
('659004', '新疆维吾尔族自治区五家渠市'),
('710000', '台湾省'),
('810000', '香港特别行政区'),
('820000', '澳门特别行政区');
